...
mutations_file = '/work/pi_annagreen_umass_edu/mahbuba/phenotype_prediction/resistance_forecast/mutations_with_one_letter.csv'
delta_z_file = '/work/pi_annagreen_umass_edu/mahbuba/phenotype_prediction/resistance_forecast/delta_z_values.csv'
output_file = '/work/pi_annagreen_umass_edu/mahbuba/phenotype_prediction/resistance_forecast/updated_delta_z_values.csv'
...
merged_df.to_csv('/work/pi_annagreen_umass_edu/mahbuba/phenotype_prediction/resistance_forecast/final_delta_z_with_catalog_info.csv', index=False)

print(f"Updated Delta-Z values with additional columns have been saved to {output_file}.")
